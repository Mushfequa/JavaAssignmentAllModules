package module2;
/*Question19
*W.A.J.P to find the second most frequent character is given string
*The given string is successes .the second most frequent char in the strig is:c
*/
import java.util.*;
public class FrequentCharecter {
	...
	System.out.println("No secod most frequent character found in the string.");
	}
	}
